...
# 2026_01_25_unity_ggj_mask_and_shader_cardboard

**Building a “reality hacker” style application in Unity to learn Git, Shader Graph, and compute shaders**
...
This repository includes a collection of texturing and shader tools to help understand and build this type of application. Two versions are provided:

* an **XR version for Quest 3**
* a **Cardboard version**
